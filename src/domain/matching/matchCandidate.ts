import {
  IDENTITY_CONTACT_TYPES,
  computeIdentityNormalizedValue,
} from "../../lib/normalization/contactValue";
import { normalizeName } from "../../lib/normalization/name";
import { normalizeOrganizationName } from "../../lib/normalization/organizationName";
import type { PersonCandidate, PersonScalarsCandidate } from "../ingestion/candidateTypes";
